...
The application currently includes 47 wines from various regions:
...
The application comes with a curated collection of 47 wines from various regions. To add your own wines:
