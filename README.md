...
The application currently includes 62 wines from various regions:
...
The application comes with a curated collection of 62 wines from various regions. To add your own wines:
